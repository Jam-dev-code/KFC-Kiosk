    ...
    <div class="bodyy">
        ...
        <div class="container my-4" id="cont">
            <div class="col-md-12 my-5">
                <div class="card">
                    <div class="card-body cart" style="background-color: #f6f6f6;border: double #a41e1d 3px">
                        <div class="col-sm-12 empty-cart-cls text-center" style="margin: 10px;">
                            <br><br>
                            <h2 style="font-size: 50px;color: black"><strong>Thank you for ordering from KFC!</strong></h2>
                            <br>
                            <h2>Your order ID is </h2>
                            <h1 style="font-size: 160px;color:#a41e1d"><?php echo '#' . $orderID1; ?></h1>
                            <div class="waviy">
                                <h2>
