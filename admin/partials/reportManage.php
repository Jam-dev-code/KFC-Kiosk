    ...
    <div class="table-wrapper">
            ...
            <div class="row">
                ...
                <form action="index.php?page=reportManage" id="dateForm"  method="POST">
                                <div class="form-group">
                                    <label for="sdate">Choose Date . from :</label>
                                    <input type="date" name="sdate" id="sdate" value="<?= $sdate ?>" required="required">

                                    <label for="edate">to : </label>
                                    <input type="edate" name="edate" id="edate" value="<?= $edate ?>" required="required">
                                    <button class="btn btn-sm btn-outline-primary"><i class="fa fa-filter"></i> Filter</button>
                                </div>
        ...
        <table class="table table-striped table-hover text-center" id="NoOrder">
            ...
            <tbody>
                <?php
                    $sql = "SELECT * FROM `orders`
                    where date(orderDate) between '{$sdate}' and '{$sdate}'
