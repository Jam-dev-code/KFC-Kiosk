            ...
            <div class="col-lg-4">
                <div class="card wish-list mb-3">
                    ...
                    <div class="alert alert-info mb-0" style="width: -webkit-fill-available;">
                        <strong>Info!</strong> Only Debit/Credit Card Payment Method is acceptable!
                    </div> <br>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3 bg-light">
                                ...
                                <span><strong>PHP. <?php echo ($totalPrice=$totalPrice + ($totalPrice * 0.03)) ?></strong></span>
                            </li>
                        </ul>
                        <br>
